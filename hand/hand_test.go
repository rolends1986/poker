...
var tests = []testPair{
	{
		pokertest.Cards("Ks", "Qs", "Js", "As", "9d"),
		pokertest.Cards("As", "Ks", "Qs", "Js", "9d"),
		HighCard,
		"high card ace high",
	},
	{
		pokertest.Cards("Ks", "Qh", "Qs", "Js", "9d"),
		pokertest.Cards("Qh", "Qs", "Ks", "Js", "9d"),
		Pair,
		"pair of queens",
	},
	{
		pokertest.Cards("2s", "Qh", "Qs", "Js", "2d"),
		pokertest.Cards("Qh", "Qs", "2s", "2d", "Js"),
		TwoPair,
		"two pair queens and twos",
	},
	{
		pokertest.Cards("6s", "Qh", "Ks", "6h", "6d"),
		pokertest.Cards("6s", "6h", "6d", "Ks", "Qh"),
		ThreeOfAKind,
		"three of a kind sixes",
	},
	{
		pokertest.Cards("Ks", "Qs", "Js", "As", "Td"),
		pokertest.Cards("As", "Ks", "Qs", "Js", "Td"),
		Straight,
		"straight ace high",
	},
	{
		pokertest.Cards("2s", "3s", "4s", "As", "5d"),
		pokertest.Cards("5d", "4s", "3s", "2s", "As"),
		Straight,
		"straight five high",
	},
	{
		pokertest.Cards("7s", "4s", "5s", "3s", "2s"),
		pokertest.Cards("7s", "5s", "4s", "3s", "2s"),
		Flush,
		"flush seven high",
	},
	{
		pokertest.Cards("7s", "7d", "3s", "3d", "7h"),
		pokertest.Cards("7s", "7d", "7h", "3s", "3d"),
		FullHouse,
		"full house sevens full of threes",
	},
	{
		pokertest.Cards("7s", "7d", "3s", "7c", "7h"),
		pokertest.Cards("7s", "7d", "7c", "7h", "3s"),
		FourOfAKind,
		"four of a kind sevens",
	},
	{
		pokertest.Cards("Ks", "Qs", "Js", "Ts", "9s"),
		pokertest.Cards("Ks", "Qs", "Js", "Ts", "9s"),
		StraightFlush,
		"straight flush king high",
	},
	{
		pokertest.Cards("As", "5s", "4s", "3s", "2s"),
		pokertest.Cards("5s", "4s", "3s", "2s", "As"),
		StraightFlush,
		"straight flush five high",
	},
	{
		pokertest.Cards("As", "Ks", "Qs", "Js", "Ts"),
		pokertest.Cards("As", "Ks", "Qs", "Js", "Ts"),
		RoyalFlush,
		"royal flush",
	},
	{
		pokertest.Cards("As", "Ks", "Qs", "2s", "2c", "2h", "2d"),
		pokertest.Cards("2s", "2c", "2h", "2d", "As"),
		FourOfAKind,
		"four of a kind twos",
	},
}
...
var equalityTests = []testEquality{
	{
		pokertest.Cards("As", "5s", "4s", "3s", "2s"),
		pokertest.Cards("Ks", "Kc", "Kh", "Jd", "Js"),
		greaterThan,
	},
	{
		pokertest.Cards("Ts", "9h", "8d", "7c", "6s", "2h", "3s"),
		pokertest.Cards("Ts", "9h", "8d", "7c", "6s", "Ah", "Ks"),
		equalTo,
	},
	{
		pokertest.Cards("Th", "Ts", "3d", "3s", "As", "8h"),
		pokertest.Cards("8s", "8c", "3d", "3s", "As", "Th", "Qh"),
		greaterThan,
	},
}
...
var optTests = []testOptionsPairs{
	{
		pokertest.Cards("Ks", "Qs", "Js", "As", "9s"),
		pokertest.Cards("As", "Ks", "Qs", "Js", "9s"),
		[]func(*Config){Low},
		Flush,
		"flush ace high",
	},
	{
		pokertest.Cards("7h", "6h", "5s", "4s", "2s", "3s"),
		pokertest.Cards("6h", "5s", "4s", "3s", "2s"),
		[]func(*Config){AceToFiveLow},
		HighCard,
		"high card six high",
	},
	{
		pokertest.Cards("Ah", "6h", "5s", "4s", "2s", "Ks"),
		pokertest.Cards("6h", "5s", "4s", "2s", "Ah"),
		[]func(*Config){AceToFiveLow},
		HighCard,
		"high card six high",
	},
